...
annpath='/home/intern24/BLIVA/bliva/data/raw_data/mscoco_train2014_annotations.json'
with open(annpath, "r") as f:
    data = json.load(f)

annpath2='/home/intern24/BLIVA/bliva/data/raw_data/OpenEnded_mscoco_train2014_questions.json'
...
with open('BLIVA/bliva/data/raw_data/okvqa_train.json', 'w') as f:
    json.dump(data,f)